...
declare module '@polkadot/api/types/errors' {
  export interface AugmentedErrors<ApiType> {
    ...
    bulletTrain: {
       ...
       **/
      CabinNotAvailable: AugmentedError<ApiType>;
      /**
       ...
       **/
      DpoWrongState: AugmentedError<ApiType>;
      /**
       ...
       **/
      InvalidBuyerType: AugmentedError<ApiType>;
      /**
       * dpo end date must be later than now and before target dpo end date
       **/
      InvalidEndTime: AugmentedError<ApiType>;
      /**
       ...
       **/
      InvalidPaymentType: AugmentedError<ApiType>;
      /**
       * InvalidReferrerType <= None
       **/
      InvalidReferrerType: AugmentedError<ApiType>;
      /**
       ...
       **/
      RewardValueTooSmall: AugmentedError<ApiType>;
      /**
       * target dpo or travel_cabin deposit required too big
       **/
      TargetValueTooBig: AugmentedError<ApiType>;
      /**
       ...
       **/
      TravelCabinHasNotMatured: AugmentedError<ApiType>;
      /**
       * no contribution to withdraw
       **/
      ZeroBalanceToWithdraw: AugmentedError<ApiType>;
      /**
       * Generic error
       **/
      [key: string]: AugmentedError<ApiType>;
    ...
    dex: {
       ...
       **/
      ExceedPriceImpactLimit: AugmentedError<ApiType>;
      /**
       ...
       **/
      NotEnabledTradingPair: AugmentedError<ApiType>;
      /**
    ...
    rewards: {
       ...
       **/
      EmptyRewards: AugmentedError<ApiType>;
      /**
       * Invalid currency id
       **/
      InvalidCurrencyId: AugmentedError<ApiType>;
       ...
       * reward to small
       **/
      RewardTooSmall: AugmentedError<ApiType>;
      /**
       * scheduled event starting too soon
       **/
      StartTooSoon: AugmentedError<ApiType>;
      /**
       * Generic error
       **/
      [key: string]: AugmentedError<ApiType>;
