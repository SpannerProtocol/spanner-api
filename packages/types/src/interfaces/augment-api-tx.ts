...
import type { DpoIndex, Target, TravelCabinIndex, TravelCabinInventoryIndex } from 'packages/types/src/interfaces/bulletTrain';
import type { AmountOf, CurrencyId, CurrencyIdOf } from 'packages/types/src/interfaces/primitives';
import type { AccountId, AccountIndex, AssetId, Balance, BalanceOf, BlockNumber, Call, CallHashOf, ChangesTrieConfiguration, Hash, Header, KeyValue, LookupSource, Moment, OpaqueCall, Perbill, Percent, Weight } from 'packages/types/src/interfaces/runtime';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    bulletTrain: {
       ...
       **/
      createMilestoneReward: AugmentedSubmittable<(tokenId: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, milestone: Balance | AnyNumber | Uint8Array, reward: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Balance, Balance]>;
      /**
       ...
       **/
      createTravelCabin: AugmentedSubmittable<(tokenId: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, name: Bytes | string | Uint8Array, depositAmount: Balance | AnyNumber | Uint8Array, bonusTotal: Balance | AnyNumber | Uint8Array, yieldTotal: Balance | AnyNumber | Uint8Array, maturity: BlockNumber | AnyNumber | Uint8Array, stockpile: TravelCabinInventoryIndex | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Bytes, Balance, Balance, Balance, BlockNumber, TravelCabinInventoryIndex]>;
      /**
       ...
       **/
      releaseBonusFromDpo: AugmentedSubmittable<(dpoIdx: DpoIndex | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [DpoIndex]>;
      /**
       * anyone can call this function
       * can only withdraw from COMPLETED or FAILED state
       **/
      releaseFareFromDpo: AugmentedSubmittable<(dpoIdx: DpoIndex | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [DpoIndex]>;
      releaseMilestoneReward: AugmentedSubmittable<(tokenId: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId]>;
      /**
       * anyone can call this function
       **/
    ...
    dex: {
       ...
       * liquidity pool.
       **/
      addLiquidity: AugmentedSubmittable<(currencyIdA: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, currencyIdB: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, maxAmountA: Compact<Balance> | AnyNumber | Uint8Array, maxAmountB: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, CurrencyId, Compact<Balance>, Compact<Balance>]>;
      disableTradingPair: AugmentedSubmittable<(currencyIdA: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, currencyIdB: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, CurrencyId]>;
      /**
       * Enable a new trading pair(without the provision process),
       * or re-enable a disabled trading pair.
       **/
      enableTradingPair: AugmentedSubmittable<(currencyIdA: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, currencyIdB: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, CurrencyId]>;
      /**
       * List a new trading pair, trading pair will become Enabled status
       * after provision process.
       **/
      listTradingPair: AugmentedSubmittable<(currencyIdA: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, currencyIdB: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, minContributionA: Balance | AnyNumber | Uint8Array, minContributionB: Balance | AnyNumber | Uint8Array, targetProvisionA: Balance | AnyNumber | Uint8Array, targetProvisionB: Balance | AnyNumber | Uint8Array, notBefore: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, CurrencyId, Balance, Balance, Balance, Balance, BlockNumber]>;
      /**
       ...
       * is on incentives.
       **/
      removeLiquidity: AugmentedSubmittable<(currencyIdA: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, currencyIdB: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, removeShare: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, CurrencyId, Compact<Balance>]>;
      /**
       ...
       **/
      swapWithExactSupply: AugmentedSubmittable<(path: Vec<CurrencyId> | (CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array)[], supplyAmount: Compact<Balance> | AnyNumber | Uint8Array, minTargetAmount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<CurrencyId>, Compact<Balance>, Compact<Balance>]>;
      /**
       ...
       **/
      swapWithExactTarget: AugmentedSubmittable<(path: Vec<CurrencyId> | (CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array)[], targetAmount: Compact<Balance> | AnyNumber | Uint8Array, maxSupplyAmount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<CurrencyId>, Compact<Balance>, Compact<Balance>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    rewards: {
      addYieldFarmingReward: AugmentedSubmittable<(lpToken: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Balance]>;
      claimReward: AugmentedSubmittable<(lpToken: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId]>;
      depositDexShare: AugmentedSubmittable<(lpToken: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Balance]>;
      scheduleYieldFarmingRewards: AugmentedSubmittable<(lpToken: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, rewards: Vec<ITuple<[Balance, BlockNumber, BlockNumber, u8]>> | ([Balance | AnyNumber | Uint8Array, BlockNumber | AnyNumber | Uint8Array, BlockNumber | AnyNumber | Uint8Array, u8 | AnyNumber | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [CurrencyId, Vec<ITuple<[Balance, BlockNumber, BlockNumber, u8]>>]>;
      withdrawDexShare: AugmentedSubmittable<(lpToken: CurrencyId | { Token: any } | { DexShare: any } | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Balance]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
