...
import type { DpoIndex, TravelCabinIndex, TravelCabinInventoryIndex } from 'packages/types/src/interfaces/bulletTrain';
import type { AccountId, BlockNumber, H160, H256, H64, Hash, Header, Index, Justification, KeyValue, SignedBlock, StorageData } from 'packages/types/src/interfaces/runtime';
...
declare module '@polkadot/rpc-core/types.jsonrpc' {
  export interface RpcInterface {
    ...
    bulletTrain: {
       ...
       * Get dpos of account
       **/
      getDposOfAccount: AugmentedRpc<(account: AccountId | string | Uint8Array, at?: Hash | string | Uint8Array) => Observable<Vec<DpoIndex>>>;
      /**
       * Get travel cabins of account
       **/
      getTravelCabinsOfAccount: AugmentedRpc<(account: AccountId | string | Uint8Array, at?: Hash | string | Uint8Array) => Observable<Vec<ITuple<[TravelCabinIndex, TravelCabinInventoryIndex]>>>>;
    };
    chain: {
      /**
